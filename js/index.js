...
var Pomodoro = (function(_React$Component) {
  ...
  function Pomodoro(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Pomodoro.__proto__ || Object.getPrototypeOf(Pomodoro)).call(this, props)
    );
    ...
    _this.handleController = function(time, action) {
    ...
    _this.timerStart = _this.timerStart.bind(_this);
  ...
  _createClass(Pomodoro, [
    ...
    {
      key: 'timeLeftToString',
      value: function timeLeftToString() {
        var minutes = Math.floor(this.state.timeLeft / 60);
        var seconds = this.state.timeLeft % 60;
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'label',
              { class: 'length-label', id: 'break-label' },
              'Break Length'
            ),
            ...
            React.createElement(
              'button',
              {
                ...
                onClick: function onClick() {
                  return _this2.handleController('break', '+');
                }
              },
              '+'
            ),
            ...
            React.createElement(
              'label',
              { class: 'length-time', id: 'break-length' },
          ...
          React.createElement(
            ...
            React.createElement(
              'label',
              { class: 'length-label', id: 'session-label' },
              'Session Length'
            ),
            ...
            React.createElement(
              'button',
              {
                ...
                onClick: function onClick() {
                  return _this2.handleController('session', '+');
                }
              },
              '+'
            ),
            ...
            React.createElement(
              'label',
              { class: 'length-time', id: 'session-length' },
          ...
          React.createElement(
            ...
            React.createElement(
              'label',
              { id: 'timer-label' },
              this.state.currTime === 's' ? 'Session' : 'Break'
            ),
            React.createElement(
              'label',
              { id: 'time-left' },
